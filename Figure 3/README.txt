...
This README file corresponds to the data corresponding to Figure 3 of the manuscript.
...
In the Figure 3 folder, two subfoldors can be found, namely:

1. Unprocessed_Figure:
This folder contains two PDF files with the figures as generated by R. 
These two PDF files are combined as Figure 3. 
