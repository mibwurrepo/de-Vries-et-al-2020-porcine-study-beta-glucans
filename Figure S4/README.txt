...
This README file corresponds to the data corresponding to Figure S4 of the manuscript.
...
***Purpose of analysis***
To investigate how microbial composition of the gut microbiota develops over time with special attention to genera that drive the differences in microbial composition between treatment groups
...
In the Figure S4 folder, two subfoldors can be found, namely:

1. Unprocessed_Figure:
This folder contains two PDF files with the figures as generated by R. 
These two PDF files are combined as Figure S4. 
