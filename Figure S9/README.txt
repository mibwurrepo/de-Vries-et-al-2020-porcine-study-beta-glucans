...
This README file corresponds to the data corresponding to Figure S9 of the manuscript.
...
***Purpose of analysis***
To investigate correlations between physiological, microbial and immunological parameters with special focus on the ileum segment. Most data used here is from day 27 of the study.
...
In the Figure S9 folder, two subfoldors can be found, namely:

1. Unprocessed_Figure:
This folder contains the PDF file with the figure as generated by R. 
This PDF file was used to create Figure S9. 
...
In the 'input_data' folder, an excel file containing data used to generate this figure can also be found: ileum_metadata_plus_genera_abundances_for_correlation_figure