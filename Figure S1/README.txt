...
This README file corresponds to the data corresponding to Figure S1 of the manuscript.
...
***Purpose of analysis***
To investigate the effect of the treatment on the pH of different gut segments.

***Methodological information***
The pH was measured in luminal digesta from different gut segments with a pH meter.
...
In the Figure S1 folder, two subfolders can be found, namely:

1. Unprocessed_Figure:
This folder contains one PDF file with the figure as generated by R. 
