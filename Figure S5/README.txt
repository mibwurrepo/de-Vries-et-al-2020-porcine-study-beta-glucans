...
This README file corresponds to the data corresponding to Figure S5 of the manuscript.
...
***Purpose of analysis***
To investigate how archaeal composition of the gut microbiota develops over time
...
In the Figure S5 folder, two subfoldors can be found, namely:

1. Unprocessed_Figure:
This folder contains the PDF file with the figure as generated by R. 
This PDF file was used to create Figure S5. 
